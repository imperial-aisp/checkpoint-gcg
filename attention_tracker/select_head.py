...
def main(args):
    ...
    for data in tqdm(normal_data):
        ...
        #         {"instruction": instruction, "input": data}
        #     )
        # _, _, attention_maps, _, input_range, _ = model.inference(text=text)
    ...
    for data in tqdm(attack_data):
        ...
        #         {"instruction": instruction, "input": data}
        #     )
        # _, _, attack_attention_maps, _, attack_input_range, _ = model.inference(text=text)
