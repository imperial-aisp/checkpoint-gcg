...
class Prompter(object):
    ...
    def __init__(self, template_name: str = "", verbose: bool = False):
        ...
        file_name = osp.join("data/configs", f"{template_name}.json")
...
def train(
    ...
    data_path: str = "data/training/saferpaca_Instructions_2000.json",
    output_dir: str = "meta-llama/Meta-Llama-3-8B-Instruct-2000",
    ...
    # wandb params
    wandb_mode: str = "offline",  # options: offline | online
    wandb_project: str = "offline-run-safety-tuned-Llama-3-8B-Instruct-2000",
    wandb_run_name: str = "offline-run-safety-tuned-Llama-3-8B-Instruct-2000",
    ...
    if resume_from_checkpoint:
        ...
        if os.path.exists(adapter_path):
            print(f"Restarting from {adapter_path}")
            adapters_weights = safe_load(adapter_path)
            set_peft_model_state_dict(model, adapters_weights)
        else:
            print(f"Adapter weights not found at {adapter_path}")
